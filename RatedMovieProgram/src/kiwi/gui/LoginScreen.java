	...
	public LoginScreen() {
		...
		btnForgotPassword.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				// 마우스 올리면 밝기 증가
				btnForgotPassword.setForeground(btnForgotPassword.getForeground().brighter());
			}
		...
		btnSignUp.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				// 마우스 올리면 밝기 증
				btnSignUp.setForeground(btnSignUp.getForeground().brighter());
			}
